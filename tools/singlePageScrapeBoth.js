...
const SCRAPE_CONTENT_MEDIA_SINGLE_PAGE = {
  name: "scrape_single_page_content_media",
  description: "Scrapes content and media from a single page.",
  category: "scraping",
...
module.exports = SCRAPE_CONTENT_MEDIA_SINGLE_PAGE;
