...
const CRAWL_CONTENT_MEDIA_REGEX_PATTERNS = {
  name: "crawl_using_regex_content_media",
  description:
    "Crawls content and media using regex patterns with whitelist and blacklist.",
  category: "crawling",
...
module.exports = CRAWL_CONTENT_MEDIA_REGEX_PATTERNS;
